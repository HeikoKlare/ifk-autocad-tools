...
{
    public partial class BracingControl : UserControl
    {
        ...
        /// </summary>
        public BracingControl()
        {
            InitializeComponent();
            txtRidgeDistance.Text = firstAbstandTB.ToString();
            txtEaveDistance.Text = traufAbstandTB.ToString();
            if (feldzahlTB != 0)
            {
        ...
        private void butChangeGeometry_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void berechneMaße()
        {
            if (direction == VERTICAL)
            {
                ...
                laengeTB = lengthPoint.Y - basePoint.Y - double.Parse(txtRidgeDistance.Text)
                    - double.Parse(txtEaveDistance.Text);
            ...
            else if (direction == HORIZONTAL)
            {
                ...
                TBbreite.Text = breiteTB.ToString();
                laengeTB = lengthPoint.X - basePoint.X - double.Parse(txtRidgeDistance.Text)
                    - double.Parse(txtEaveDistance.Text);
                TBlaenge.Text = laengeTB.ToString();
        ...
        /// <param name="sender">the object sending invoke to start this command</param>
        /// <param name="e">the event arguments</param>
        private void txtEaveDistance_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        /// <param name="sender">the object sending invoke to start this command</param>
        /// <param name="e">the event arguments</param>
        private void txtEaveDistance_TextChanged(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(txtEaveDistance.Text))
            {
                traufAbstandTB = double.Parse(txtEaveDistance.Text);
                berechneMaße();
            }
        }
        ...
        /// <param name="sender">the object sending invoke to start this command</param>
        /// <param name="e">the event arguments</param>
        private void txtRidgeDistance_TextChanged(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(txtRidgeDistance.Text))
            {
                firstAbstandTB = double.Parse(txtRidgeDistance.Text);
                berechneMaße();
            }
        }
        ...
        /// <param name="sender">the object sending invoke to start this command</param>
        /// <param name="e">the event arguments</param>
        private void txtFieldCount_TextChanged(object sender, EventArgs e)
        {
        ...
        /// <param name="sender">the object sending invoke to start this command</param>
        /// <param name="e">the event arguments</param>
        private void chkEndMember_CheckedChanged(object sender, EventArgs e)
        {
        ...
        /// <param name="sender">the object sending invoke to start this command</param>
        /// <param name="e">the event arguments</param>
        private void txtFieldCount_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        /// <param name="sender">the object sending invoke to start this command</param>
        /// <param name="e">the event arguments</param>
        private void txtEaveDistance_Leave(object sender, EventArgs e)
        {
            if (String.IsNullOrEmpty(txtEaveDistance.Text)) txtEaveDistance.Text = "0.10";
        }
        ...
        /// <param name="sender">the object sending invoke to start this command</param>
        /// <param name="e">the event arguments</param>
        private void txtRidgeDistance_Leave(object sender, EventArgs e)
        {
            if (String.IsNullOrEmpty(txtRidgeDistance.Text)) txtRidgeDistance.Text = "0.10";
        }
    }
}
